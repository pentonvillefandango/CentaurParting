    ...
    try:
        ...
        with Database().transaction() as db:
            ...
            if exptime_s is not None and exptime_s > 0:
                ff_median_adu_s = (
                    _safe_float(ff_stats.median / exptime_s)
                    if ff_stats.median is not None
                    else None
                )
                ff_madstd_adu_s = (
                    _safe_float(ff_stats.madstd / exptime_s)
                    if ff_stats.madstd is not None
                    else None
                )
                roi_median_adu_s = (
                    _safe_float(roi_stats.median / exptime_s)
                    if roi_stats.median is not None
                    else None
                )
                roi_madstd_adu_s = (
                    _safe_float(roi_stats.madstd / exptime_s)
                    if roi_stats.madstd is not None
                    else None
                )
            else:
            ...
            db.execute(
                ...
                (
                    ...
                    utc_now(),
                    fields["ff_mean_adu"],
                    fields["ff_median_adu"],
                    fields["ff_mode_adu"],
                    fields["ff_sc_mean_adu"],
                    fields["ff_sc_median_adu"],
                    fields["ff_p10_adu"],
                    fields["ff_p25_adu"],
                    fields["ff_p50_adu"],
                    fields["ff_p75_adu"],
                    ...
                    fields["ff_max_adu"],
                    fields["ff_std_adu"],
                    fields["ff_sc_std_adu"],
                    fields["ff_mad_adu"],
                    fields["ff_madstd_adu"],
                    fields["ff_iqr_adu"],
                    fields["ff_median_adu_s"],
                    fields["ff_madstd_adu_s"],
                    fields["roi_mean_adu"],
                    fields["roi_median_adu"],
                    fields["roi_mode_adu"],
                    fields["roi_sc_mean_adu"],
                    fields["roi_sc_median_adu"],
                    fields["roi_p10_adu"],
                    fields["roi_p25_adu"],
                    fields["roi_p50_adu"],
                    fields["roi_p75_adu"],
                    ...
                    fields["roi_max_adu"],
                    fields["roi_std_adu"],
                    fields["roi_sc_std_adu"],
                    fields["roi_mad_adu"],
                    fields["roi_madstd_adu"],
                    fields["roi_iqr_adu"],
                    fields["roi_median_adu_s"],
                    fields["roi_madstd_adu_s"],
                    nan_fraction,
                    inf_fraction,
                    ff_stats.clipped_fraction,
                    roi_stats.clipped_fraction,
                ),
            )
